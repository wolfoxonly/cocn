...
#ifdef TESTING
void DakeCoinMiner(CWallet *pwallet, bool fProofOfStake, bool fGenerateSingleBlock = false);
#else
...
public:
    ...
    */
    ...
    /** Amount of DakeCoins spent by this transaction.
    ...
    /** Amount of DakeCoins coming in to this transaction
...
public:
    ...
    /**
     * Duplicate from DakeCoinrpc that originaly define this method.
