...
static const uint256 hashGenesisBlockOfficial("0x000000559e2eac4a9686b3111f586b618f187c63bdaa7c278f3b68325f75f9a5");//<coingo.vip>校验
...
#ifdef TESTING
void CloudComputingChainMiner(CWallet *pwallet, bool fProofOfStake, bool fGenerateSingleBlock = false);
#else
...
public:
    ...
    */
    ...
    /** Amount of CloudComputingChains spent by this transaction.
    ...
    /** Amount of CloudComputingChains coming in to this transaction
...
public:
    ...
    /**
     * Duplicate from CloudComputingChainrpc that originaly define this method.
