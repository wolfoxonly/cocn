...
const QString BITCOIN_IPC_PREFIX("CloudComputingChain:");
...
{
    QString name("CloudComputingChainQt");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click CloudComputingChain: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start CloudComputingChain: click-to-pay handler");
    else
...
{
    // clicking on CloudComputingChain: URLs creates FileOpen events on the Mac:
