...
{
    BOOST_CHECK(TestSplitHost("www.CloudComputingChain.org", "www.CloudComputingChain.org", -1));
    BOOST_CHECK(TestSplitHost("[www.CloudComputingChain.org]", "www.CloudComputingChain.org", -1));
    BOOST_CHECK(TestSplitHost("www.CloudComputingChain.org:80", "www.CloudComputingChain.org", 80));
    BOOST_CHECK(TestSplitHost("[www.CloudComputingChain.org]:80", "www.CloudComputingChain.org", 80));
