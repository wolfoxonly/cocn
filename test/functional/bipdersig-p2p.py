...
class BIP66Test(CloudComputingChainTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # CloudComputingChaind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and CloudComputingChaind produces more specific reject
            # reasons.
