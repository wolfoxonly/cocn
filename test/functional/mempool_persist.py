...
By default, CloudComputingChaind will dump mempool on shutdown and
...
class MempoolPersistTest(CloudComputingChainTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(1)
        self.start_node(2)
        # Give CloudComputingChaind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent CloudComputingChaind from writing mempool.dat to disk. Verify that `savemempool` fails")
