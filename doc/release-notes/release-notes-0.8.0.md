CloudComputingChain-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/CloudComputingChain/files/CloudComputingChain/CloudComputingChain-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the CloudComputingChain
...
New/changed settings (command-line or CloudComputingChain.conf file)
--------------------------------------------------------
