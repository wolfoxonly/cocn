CloudComputingChain version 0.5.4 is now available for download at:
http://sourceforge.net/projects/CloudComputingChain/files/CloudComputingChain/CloudComputingChain-0.5.4/
...
http://gitorious.org/CloudComputingChain/CloudComputingChaind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix CloudComputingChain-Qt notifications under Growl 1.3.
Increase required age of CloudComputingChain-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCloudComputingChain properly when installing CloudComputingChain-Qt over it. (Windows)
