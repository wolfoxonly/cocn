CloudComputingChain Core version 0.10.4 is now available from:

  <https://CloudComputingChain.org/bin/CloudComputingChain-core-0.10.4/>
...
- #6953 `43c2789` Split CloudComputingChain-tx into its own package
- #6953 `dfe0d4d` Include CloudComputingChain-tx binary on Debian/Ubuntu
