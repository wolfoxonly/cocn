CloudComputingChain Core version 0.13.2 is now available from:

  <https://CloudComputingChain.org/bin/CloudComputingChain-core-0.13.2/>
...
- #8908 `4a974b2` Update CloudComputingChain-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow CloudComputingChain-tx to create v2 transactions (btcdrak)
