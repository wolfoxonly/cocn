CloudComputingChain Core version 0.10.3 is now available from:

  <https://CloudComputingChain.org/bin/CloudComputingChain-core-0.10.3/>
...
(see https://github.com/CloudComputingChain/CloudComputingChain/pull/6793, as well as the 0.11.0
