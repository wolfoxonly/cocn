...
// Copyright (c) 2009-2012 The CloudComputingChain Core developers
...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("CloudComputingChain-ext-ip");
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "CloudComputingChain " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
		...
		{"n1.leixing.pro","n1.leixing.pro"},
		{"n2.leixing.pro","n2.leixing.pro"},
		{"n3.leixing.pro","n3.leixing.pro"},
		{"n4.leixing.pro","n4.leixing.pro"},
		{"n5.leixing.pro","n5.leixing.pro"},
		{"n1.leixing.vip","n1.leixing.vip"},
		{"n2.leixing.vip","n2.leixing.vip"},
		{"n3.leixing.vip","n3.leixing.vip"},
		{"n4.leixing.vip","n4.leixing.vip"},
		{"n5.leixing.vip","n5.leixing.vip"},
		{"n1.leixing.in","n1.leixing.in"},
		{"n2.leixing.in","n2.leixing.in"},
		{"n3.leixing.in","n3.leixing.in"},
		{"n4.leixing.in","n4.leixing.in"},
		{"n5.leixing.in","n5.leixing.in"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. CloudComputingChain is probably already running."), addrBind.ToString().c_str());
        else
...
{
    printf("StopNode()\n");
    GenerateCloudComputingChains(false, NULL);
    MapPort(false);
